  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="grid grid-cols-2 gap-10">
        {/* Enable/Disable */}
        <div style={{ background: '#FEFDFB', borderRadius: 12, border: '1.4px solid #e4ddd1', padding: 24, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }} className="space-y-10 col-span-2">
          ...
          <div className="space-y-6">
            <div>
              ...
              <select
                ...
                className="w-full bg-white border border-[#e4ddd1] rounded-lg px-4 py-2.5 text-sm font-medium text-[#23282A] outline-none focus:ring-2 focus:ring-[#1f8577]/20 focus:border-[#1f8577] transition-all"
              >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-[#e4ddd1] rounded-lg pl-8 pr-4 py-2.5 text-sm font-medium text-[#23282A] outline-none focus:ring-2 focus:ring-[#1f8577]/20 focus:border-[#1f8577] transition-all"
                  />
                </div>
              </div>
            )}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-[#e4ddd1] rounded-lg pl-10 pr-4 py-2.5 text-sm font-medium text-[#23282A] outline-none focus:ring-2 focus:ring-[#1f8577]/20 focus:border-[#1f8577] transition-all"
                  />
                </div>
              </div>
            )}
        ...
        {/* Safety Controls */}
        <div style={{ background: '#FEFDFB', borderRadius: 12, border: '1.4px solid #e4ddd1', padding: 24, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }} className="space-y-8 col-span-2">
          <div className="flex items-center gap-2">
          ...
          <div style={{ background: '#FEFDFB', borderRadius: 12, border: '1.4px solid #e4ddd1', padding: 24, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }} className="space-y-8 col-span-2">
            ...
            <div className="grid grid-cols-1 gap-4">
              {campaigns.filter(c => c.status === 'active').map(c => (
                <div key={c.id} className="flex items-center justify-between p-3 bg-[#eef7f6] rounded-lg border border-[#e4ddd1]">
                  <div>
