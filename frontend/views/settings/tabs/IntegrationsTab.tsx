          ...
          <div className="grid grid-cols-2 gap-10">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <span className="px-6 py-3 bg-[#eef7f6] text-[#1f8577] border border-[#e4ddd1] rounded-2xl text-[10px] font-black tracking-widest">NUMERIC</span>
                <span className="px-6 py-3 bg-[#1f8577]/50 text-[#1f8577] border border-[#1f8577]/50 rounded-2xl text-[10px] font-black tracking-widest">SPECIAL CHAR</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section>
        ...
        <div style={{ background: '#FEFDFB', borderRadius: 12, border: '1.4px solid #e4ddd1', padding: 24, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }} className="space-y-8">
          {(config.integrationSettings?.externalApis || []).map((apiItem, index) => (
            <div key={apiItem.id} style={{ background: '#eef7f6', borderRadius: 12, border: '1.4px solid #e4ddd1', padding: 24 }}>
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-6">
                  <div className="p-4 bg-white rounded-md shadow-sm text-[#5c6567] border border-[#e4ddd1]">
                    <Globe size={28} />
                  </div>
                  <div>
                    <input
              ...
              <div className="grid grid-cols-2 gap-10">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-4 bg-white border border-[#e4ddd1] rounded-2xl font-bold text-sm outline-none focus:ring-4 focus:ring-[#1f8577]/5 focus:border-[#1f8577] transition-all"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      type="password"
                      className="w-full px-5 py-4 bg-white border border-[#e4ddd1] rounded-2xl font-bold text-sm outline-none focus:ring-4 focus:ring-[#1f8577]/5 focus:border-[#1f8577] pr-12 transition-all"
          ...
          <button
            ...
            className="w-full py-6 border-2 border-dashed border-[#e4ddd1] rounded-lg text-[#5c6567] font-bold uppercase text-xs tracking-widest hover:border-[#1f8577] hover:text-[#1f8577] hover:bg-[#eef7f6] transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
          >
      ...
      <section>
        ...
        <div style={{ background: '#FEFDFB', borderRadius: 12, border: '1.4px solid #e4ddd1', padding: 24, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }} className="space-y-8">
          {(config.integrationSettings?.webhooks || []).map((hook, index) => (
            <div key={hook.id} style={{ background: '#eef7f6', borderRadius: 12, border: '1.4px solid #e4ddd1', padding: 24 }}>
              <div className="flex justify-between items-start mb-10">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-[#e4ddd1] rounded-2xl px-5 py-4 font-bold text-[#23282A] outline-none focus:ring-4 focus:ring-[#1f8577]/5 focus:border-[#1f8577] transition-all text-sm"
                    value={hook.url}
                    onChange={e => {
                ...
                <div className="ml-10 flex items-center gap-6 pt-7">
                  ...
                  <button
                    ...
                    className="p-4 bg-white rounded-2xl border border-[#e4ddd1] text-[#e4ddd1] hover:text-[#b5493f] hover:border-[#a6d9d3] hover:bg-[#eef7f6] transition-all shadow-sm active:scale-90"
                  >
                    <Trash2 size={20} />
                  </button>
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  {['sale.created', 'inventory.low', 'customer.created', 'production.complete'].map(event => (
                    <button
                      ...
                      className={`px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all border ${(hook.events || []).includes(event) ? 'bg-[#1f8577] text-white border-[#1f8577] shadow-lg shadow-[#1f8577]/20' : 'bg-white text-[#5c6567] border-[#e4ddd1] hover:border-[#a6d9d3] hover:bg-[#eef7f6] hover:text-[#1f8577]'}`}
                    >
                      {event.replace('.', ' ')}
                    </button>
                  ))}
