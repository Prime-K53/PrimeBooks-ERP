    ...
    FOR t IN
        ...
        WHERE n.nspname = 'public'
          ...
          AND c.relname IN (
            ...
            'ledger_entries', 'accounts', 'reminders', 'settings',
            ...
            'bank_cashflow_forecasts', 'bank_alerts', 'bank_categories',
            -- Payments / Wallet
            'customer_payments', 'supplier_payments',
            'wallet_transactions', 'recurring_invoices', 'scheduled_payments',
            'delivery_notes', 'subcontract_orders', 'maintenance_logs',
            ...
            'examination_papers', 'exam_printing_batches',
            -- Production
